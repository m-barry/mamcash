  ...
  <div class="col-xl-4 col-lg-5 col-md-6 col-sm-9">
    ...
    <div id="mode-classique">
      ...
      <div id="step-0" class="card shadow p-4 mb-3">
        <h5 class="text-primary mb-4 text-center">Convertisseur de devises en GNF</h5>
        <div class="mb-3 text-center text-secondary small">
          Taux de change : <span class="text-success fw-bold" id="rateDisplay">1 EUR = {{ number_format($rates['EUR'], 0, ',', ' ') }} GNF</span>
        </div>
